...
import es.ieselrincon.dam.ppp.surveyhubdesktop.models.Role;
...
public class RoleDAO {
    ...
    static {
        ...
        HibernateUtils.initializeAnnotatedClass("es.ieselrincon.dam.ppp.surveyhubdesktop.models.Role");
    }
    ...
    public long count() {
        try (Session session = HibernateUtils.getSession()) {
            Query<Long> query = session.createQuery("select count(r.id) from Role r", Long.class);
