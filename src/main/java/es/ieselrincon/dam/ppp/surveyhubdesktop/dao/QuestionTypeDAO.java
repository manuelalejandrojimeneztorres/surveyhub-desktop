...
public class QuestionTypeDAO {
    ...
    static {
        ...
        HibernateUtils.initializeAnnotatedClass("es.ieselrincon.dam.ppp.surveyhubdesktop.models.QuestionType");
    }
    ...
    public List<QuestionType> findAll() {
        try (Session session = HibernateUtils.getSession()) {
            return session.createQuery("from QuestionType", QuestionType.class).list();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
